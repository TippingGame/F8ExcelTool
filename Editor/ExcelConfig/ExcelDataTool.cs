...
public class ExcelDataTool
{
    ...
    public const string BinDataFolder = "/F8ExcelTool/Resources/BinConfigData"; //序列化的数据文件都会放在此文件夹内,此文件夹位于Resources文件夹下用于读取数据
    ...
    public const string DLLFolder = "/F8ExcelTool/Scripts"; //存放dll目录
